 ...
 const categories = [
    {
        title: 'Tent Camping',
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679602877/YelpCamp/tent_camping_ozkq67_mkpu1e.jpg',
    ...
    },
    {
        ...
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679603108/YelpCamp/car_campig_ecwotw_xpur1p.jpg',
    ...
    },
    {
        title: 'Canoe Camping',
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679603200/YelpCamp/canoe_camping_pmb9dn_cbbg3e.jpg',
    ...
    },
    {
        ...
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679603267/YelpCamp/survivalist_camping_qlusvd_g5gr3v.jpg',
    ...
    },
    {
        ...
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679603317/YelpCamp/backpacking_camping_aj2baw_teqikv.jpg',
    ...
    },
    {
        ...
        image: {
            url: 'https://res.cloudinary.com/ddeou172s/image/upload/v1679603367/YelpCamp/Glamping_vxgov2_xthqyg.jpg',
...
const insert = async () => {
    const category = new Category({
        ...
        image: {
            url: categories[0].image.url,
            filename: categories[0].image.filename
        },
